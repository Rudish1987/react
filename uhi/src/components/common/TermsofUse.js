...
export default function TermsOfUse({ openModal = false, handleModalClose }) {
	...
	return (
		<React.Fragment>
			<Dialog
				...
				scroll={scroll}
				fullWidth={true}
				maxWidth={getBreakPointName()}
				aria-labelledby="scroll-dialog-title"
				aria-describedby="scroll-dialog-description"
				id='dialog-box-terms'
			>
				<DialogTitle id="scroll-dialog-title" sx={{ fontFamily: theme.typography.fontFamily, fontWeight: theme.typography.fontWeightBold }}>{t('Terms of use')}</DialogTitle>
				<DialogContent dividers={scroll === 'paper'} id='dialog-content-id'>
					<DialogContentText
						id="scroll-dialog-description"
						ref={descriptionElementRef}
						tabIndex={-1}
					>
						<Stack id='data-terms-api' className="contactusTable" sx={{ fontFamily: theme.typography.fontFamily }} color={'grey.900'}>
							<Typography className="term-of-use-title" sx={{ fontSize: theme.typography.h6 }}>UMRAH HOLIDAYS INTERNATIONAL, A DIVISION OF WEBBEDS FZ LLC (UHI) BOOKING TERMS & CONDITIONS</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>1. Bookings</Typography>
							...
							<Typography className="modal-para">x. Bedding type should be requested at the time of booking and is subjected to hotel's availability.</Typography>
							...
							<Typography className="modal-para">xiii. It is your responsibility to add and train 'agents' or users under your account and to monitor all their bookings. You will be responsible for all payments due on such bookings.</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>2. Rates</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>3. Payments and Invoices</Typography>
							<Typography className="modal-para">i. All booking's invoices will be issued on the booking's arrival date for credit customers and on payment date for
								prepayment customers. Credit agencies' payment is due as per the number of days specified in your Agency Agreement</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>4. Liability</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>5. Child Policy</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>6. Transfers</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>7. Book Outs</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>8. Complaints</Typography>
							...
							<Typography className="modal-sub-title" sx={{ fontWeight: theme.typography.fontWeightBold, paddingTop:'16px' }}>9. Website Usage</Typography>
							...
							<Typography className="modal-para">vii. Multiple transactions may result in multiple postings to the cardholder's monthly statement.
							</Typography>
						</Stack>
					</DialogContentText>
				</DialogContent>
				<DialogActions id='dialog-actions-id'>
					<Button id='cancel-button-terms' onClick={handleClose}>{t('Close')}</Button>
				</DialogActions>
			</Dialog>
		</React.Fragment>
	);
