		...
		<>
			{locale.value === 'en' &&
				<Button
					...
					endIcon={<Box sx={{ position: 'absolute', right: 0, top: { lg: '7px', xs: '5px', sm: '12px' } }}>
						{clickLang ? <ArrowDropUpIcon sx={{ color: { xs: '#212121', lg: '#212121', sm: '#212121' } }} /> : <ArrowDropDownIcon sx={{ color: { xs: '#212121', lg: '#212121', sm: '#212121' } }} />}</Box>}
					ref={anchorRef}
					onClick={handleOpen}
					sx={{
						py: 1,
				...
				>
					<Typography variant="caption" sx={{ display: { xs: 'none', lg: 'block', md: 'block', sm: 'none' }, fontWeight: '600', letterSpacing: '0.0075em', color: '#212121', flex: 'none', order: 1, flexGrow: 0, textTransform: 'uppercase', paddingLeft: 1, paddingRight: 2 }}>
						{t(locale.label)}
					</Typography>
					<Typography variant="caption" sx={{ display: { xs: 'none', lg: 'none', md: 'none', sm: 'block' }, letterSpacing: '0.0075em', color: '#212121', flex: 'none', order: 1, flexGrow: 0, textTransform: 'uppercase', paddingLeft: 1, paddingRight: 2 }}>
						{t('ENG')}
					</Typography>
